    ...
    return MappingProxyType(
        {
            ...
            "subseed": int(options.get("subseed", -1)),
            "subseed_strength": float(options.get("subseed_strength", 0.0)),
            "seed_resize_from_w": int(options.get("seed_resize_from_width", 0)),
            "seed_resize_from_h": int(options.get("seed_resize_from_height", 0)),
